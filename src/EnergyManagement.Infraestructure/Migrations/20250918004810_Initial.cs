        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PeakConsumption = table.Column<double>(type: "double precision", nullable: false),
                    ...
                    DeviceNames = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConsumptionPatterns", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ConsumptionPatterns_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    PotentialSavings = table.Column<double>(type: "double precision", nullable: false),
                    PotentialSavingsPercent = table.Column<double>(type: "double precision", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EnergyRecommendations_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnomalyDetections_DeviceId_DetectedAt",
                table: "AnomalyDetections",
                columns: new[] { "DeviceId", "DetectedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_AnomalyDetections_UserId_IsResolved_DetectedAt",
                table: "AnomalyDetections",
                columns: new[] { "UserId", "IsResolved", "DetectedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsumptionPatterns_UserId_PatternType_AnalyzedAt",
                table: "ConsumptionPatterns",
                columns: new[] { "UserId", "PatternType", "AnalyzedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EnergyRecommendations_UserId_IsApplied_CreatedAt",
                table: "EnergyRecommendations",
                columns: new[] { "UserId", "IsApplied", "CreatedAt" });
